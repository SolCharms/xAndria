...
pub struct DeleteCommentOnProposedContributionModerator<'info> {
...
pub fn delete_comment_on_proposed_contribution_moderator(ctx: Context<DeleteCommentOnProposedContributionModerator>) -> Result<()> {
