...
pub struct LeaveCommentOnAnswer<'info> {
...
pub fn leave_comment_on_answer(ctx: Context<LeaveCommentOnAnswer>) -> Result<()> {
    ...
    comment.commented_on = ctx.accounts.answer.key();
